...
function love.update(dt)
    ...
    if gameState == 'play' then
        ...
        if player1.y <= ball.x or ball.y then
            player1.y =  ball.x or ball.y * dt
        end

        if player1.y >= ball.y or ball.x  then
            player1.y = ball.y or ball.x * dt
        end
        

        if player1.y >= WINDOW_HEIGHT - 50 then
            player1.y = WINDOW_HEIGHT - 50
